...
let BackGroundService = class BackGroundService {
    constructor(platform, backgroundMode, localNotifications, programadoService, notificacionService, cambiarEstadoNotificacion) {
        this.platform = platform;
        this.backgroundMode = backgroundMode;
        this.localNotifications = localNotifications;
        this.programadoService = programadoService;
        this.notificacionService = notificacionService;
        this.cambiarEstadoNotificacion = cambiarEstadoNotificacion;
    }
    iniciar() {
...
BackGroundService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    }),
...
//# sourceMappingURL=back-ground.service.js.map